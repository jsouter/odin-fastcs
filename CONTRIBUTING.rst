...
.. _GitHub: https://github.com/dls-controls/odin_fastcs/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/dls-controls/odin_fastcs.git
    $ cd odin_fastcs
    $ pipenv install --dev
    $ pipenv run tests
...
.. _release: https://github.com/dls-controls/odin_fastcs/releases
